...
Система авторизации и аутентификации пользователей не предполагаются
...
Не указано, что кноки навигации, соответствующие текущей странице, должны быть неактивны 
```
#### 8.4 UI и UX
