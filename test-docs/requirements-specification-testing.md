...
```
#### 3.8 User story:
Как клиенту, мне нужна возможность получить доброе пожелание перед 
...
| 2 | Время отклика              | Время отклика системы на любые действия пользователя должно быть небольшим секунды, кроме первоначального запуска.                                                                                                                  |
