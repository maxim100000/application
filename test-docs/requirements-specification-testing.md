...
Кроме того требование невыполнимо, поскольку задержки, связанные с запросами по сети, неизбежны
...
| 4 | Всплывающее окно закрывается кликом на кнопку снизу справа                        |
...
| 5             | Количество символов в текстовом поле | Приложение не должно ничего делать, если символов меньше 15 или больше 1500               |
```regexp
